...
def drawScreen():
	...
	if gameStatus == GAMESTATUS_TITLE:
		...
		writeText(8, 6, "  CARPMADAN SUR", "TEXT1")
		writeText(8, 10, "   MERT KOCAK", "TEXT1")
		if gameTime < 25:
			writeText(7, 13, "SPACE'E BAS VE BASLA", "TEXT1")
		if gameTime == 50:
			gameTime = 0
	if gameStatus == GAMESTATUS_START:
		if gameTime > 30 and gameTime < 50:
			writeText(12, 13, "BASLIYOR", "TEXT1")
	if gameStatus == GAMESTATUS_OVER:
		writeText(12, 11, "OYUN BITTI", "TEXT1")

	writeText(1, 1, "SKOR " + "{:06}".format(score), "TEXT1")
